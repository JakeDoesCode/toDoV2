...
function createHome() {
  ...
  allTaskImg.setAttribute('src', './assets/completed-task.png');
  ...
  todayImg.setAttribute('src', './assets/clock.png');
  ...
  importantImg.setAttribute('src', './assets/warning.png');
...
function newTaskCard(listId, title, notes, date, completed, important) {
  ...
  importantBtn.setAttribute('src', './assets/warning.png');
